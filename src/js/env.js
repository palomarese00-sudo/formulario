...
window.ENV = {
  API_URL: (typeof process !== 'undefined' && process.env ? (process.env.REACT_APP_API_URL || process.env.NEXT_PUBLIC_API_URL || process.env.API_URL || process.env.VITE_API_URL) : null)
        || 'http://localhost:3000/qualification/submit',
        
  GHL_LOCATION_ID: (typeof process !== 'undefined' && process.env ? (process.env.GHL_LOCATION_ID || process.env.VITE_GHL_LOCATION_ID || process.env.NEXT_PUBLIC_GHL_LOCATION_ID) : null)
